...
| :--- | ---: | :---:
A. Creation of an interactive and fun JavaScript game  | 5 | 5
B. Game instructions | 5 | 5
C. Game start button  | 5 | 5
D. Try again button after game completion  | 5 | 5
E. Creation of contact button, form, response, and sending an email. | 5 | 4
F. Head banner | 3 | 5
G. Characters | 4 | 5
...
* The developer wants an aesthetically pleasing and fun game to reinforce the experience and to showcase their potential and growth. There will be a landing page/home page to grab attention, with options to start the game, how to play, and contact the developer. A second page will be a game page which will then be changing throughout the game. A third page will be for the ending page, where it will change based on the ending. 
...
This website will use three pages, one for the landing page, the second for the game itself, and the third for the ending page. This is all due to javascript being able to change content and layout easily. This game will also focus on mobile-first design. 

Upon loading the page the user will be directed to the home page (index.html) where they will get options to start the game, how to play, and contact the developer. Then a game page(game.html). That takes the user through the game itself, with text boxes, and options buttons, as well as characters and backgrounds to set an atmosphere. At last, an ending page (end.html), where it will give users different endings based on scores, as well as a try again button and contact button. For simplistic use and user experience.  
...
The style is based on a minimalistic, fun, readable, contrasting design for easy flow and navigation, as well as maintaining consistency to allow the user to easily familiarise themselves with the game efficiently and intuitively.
...
The general color scheme is different color shades of blue and white. With some color details consistent with yellow and black. These colors will create a consistent style for the game. There are also other colors; from the characters and image backgrounds for the game.
...
2. Backgrounds, which are taken from Unsplash.
3. Mobile, which the developer has created through a mix of TextingStory Chat Story Maker, Canva, and Figma.

### **Typography**

To keep a consistent, playful, and modern style, and for easy readability, the fonts used are Play(for logo and ending headlines), Montserrat (the general text and heading), and Sacramento for the developers' name. These are taken from the Google Fonts library. 
...
* **Head banner:** This alerts the user that new stories and characters are coming soon. 
* **Characters:** A group of six avatars. Two will be mainly used in this game, with some different emotions and postures. 
...
* **Textboxes:** To showcase the story and dialogue.  
...
2. Go to repositories and select the one associated with this project: **[(UN)PERFECT DATE](https://github.com/VTwin90/UN-PERFECT-DATE)**.
